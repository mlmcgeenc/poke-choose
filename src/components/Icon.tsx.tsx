	...
	return (
		<div className='max-w-20 m-2'>
			<div className='w-16 h-16 relative m-auto bg-slate-200 rounded-full'>
				<div className='w-16 h-8 relative bg-red-700 rounded-t-full border-b-4 border-black'></div>
				<div className='w-16 h-8 relative  bg-white rounded-b-full border-t-4 border-black'></div>
